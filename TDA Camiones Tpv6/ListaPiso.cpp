...
*/
//esto comparaba enteros, pero ahora al ser circulos, entonces mediante qué los voy a comparar? getRadio
ResultadoComparacion compararDato(Dato dato1, Dato dato2) {
    if (getRadio(dato1)> getRadio(dato2)) {
        return MAYOR;
    }
    else if (getRadio(dato1) < getRadio(dato2)){
        return MENOR;
    }
    else {
        return IGUAL;
